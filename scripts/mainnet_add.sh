...
curl -O https://raw.githubusercontent.com/acostarodrigo/janction_mainnet/main/genesis.json
curl -O https://raw.githubusercontent.com/acostarodrigo/janction_mainnet/main/config.toml
