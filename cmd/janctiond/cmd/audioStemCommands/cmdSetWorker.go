...
func SetWorker() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short:   "Configures the audio stem worker parameters",
		Example: "janctiond audioStem setWorker alice janction15q9yw9qrrmpatsxcngwqycrgr3r7wv295kf3na test 0 1",
		Long: `Worker name is the key is used to submit transactions related to audio stem tasks.
...
GPU Amount is the amount of available GPUs that will be used to render new audio stem.
`,
